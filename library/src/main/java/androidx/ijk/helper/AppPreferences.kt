...
class AppPreferences constructor(
    ...
    // Player
    val playerPreferredQuality: String
    ...
    val playerSeekBackIncrement
        get() = sharedPreferences.getString(
            Constants.PREF_PLAYER_SEEK_BACK_INC,
            5000.toString(),
        )!!.toLongOrNull() ?: 5000
    val playerSeekForwardIncrement
        get() = sharedPreferences.getString(
    ...
    val playerMpvHwdecCodecs: Set<String>
    ...
    // Downloads
    val downloadOverMobileData
        get() = sharedPreferences.getBoolean(
            Constants.PREF_DOWNLOADS_MOBILE_DATA,
            false,
        )
    val downloadWhenRoaming
        get() = sharedPreferences.getBoolean(
