...
public class CustomGlideModule extends AppGlideModule {
    ...
    public static class MyModelLoader implements ModelLoader<Path, InputStream> {
        ...
        @Nullable
        @Override
        public LoadData<InputStream> buildLoadData(@NonNull Path model,
                                                   int width,
                                                   int height,
        ...
        @Override
        public boolean handles(@NonNull Path s) {
            return true;
        }

        public static class LoaderFactory implements ModelLoaderFactory<Path, InputStream> {
        ...
        public static class MyKey implements Key {
            ...
            public void updateDiskCacheKey(@NonNull MessageDigest messageDigest) {
                ...
                messageDigest.update((path.getPathString()).getBytes(CHARSET));
            }
        ...
        public static class MyDataFetcher implements DataFetcher<InputStream> {
            ...
            public MyDataFetcher(Path file) {
                this.file = file;
            }
            ...
            public void loadData(@NonNull Priority priority, @NonNull DataCallback<? super InputStream> callback) {
                if (!isCanceled) {
                    try {
                        ...
                        mInputStream = file.getFile().getInputStream();
